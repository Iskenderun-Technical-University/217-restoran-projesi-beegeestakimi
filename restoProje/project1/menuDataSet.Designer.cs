...
namespace project1 {
    ...
    public partial class menuDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(string isim, int fiyat) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string isim {
                get {
                    return ((string)(this[this.tableTable.isimColumn]));
                }
                set {
                    this[this.tableTable.isimColumn] = value;
                }
            }
            ...
            public int fiyat {
                get {
                    return ((int)(this[this.tableTable.fiyatColumn]));
                }
                set {
...
namespace project1.menuDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([id] = @Original_id) AND ([isim] = @Original_is" +
                "im) AND ([fiyat] = @Original_fiyat))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([id], [isim], [fiyat]) VALUES (@id, @isim, @fiyat);\r\nS" +
                "ELECT id, isim, fiyat FROM [Table] WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [id] = @id, [isim] = @isim, [fiyat] = @fiyat WHERE (([id" +
                "] = @Original_id) AND ([isim] = @Original_isim) AND ([fiyat] = @Original_fiyat))" +
                ";\r\nSELECT id, isim, fiyat FROM [Table] WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, isim, fiyat FROM dbo.[Table]";
        ...
        public virtual int Fill(menuDataSet.TableDataTable dataTable) {
        ...
        public virtual menuDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            menuDataSet.TableDataTable dataTable = new menuDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(menuDataSet.TableDataTable dataTable) {
